    ...
    return (
        <div className='px-6 md:flex md:px-20 md:items-center md:justify-between lg:py-28 md:pt-20'>
            <div className="left lg:w-8/12 lg:relative lg:z-10">
                ...
                <motion.a initial={{opacity: "0"}} animate={{opacity: 1}} transition={{duration: .7}} href="#" className='bg-gray-900 py-3 text-white px-4 tracking-widest hover:bg-blue-600 transition-all duration-200'>LET'S TALK</motion.a>
                <div className="social-media mt-28 font-medium text-xl md:mt-16">
                    <motion.p initial={{opacity: "0"}} animate={{opacity: 1}} className='text-gray-700'>Follow me</motion.p>
