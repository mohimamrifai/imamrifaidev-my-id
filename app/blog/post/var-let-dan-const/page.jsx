    ...
    return (
        <>
            ...
            <article className='mt-24 w-10/12 mx-auto md:w-8/12 md:mt-28 lg:w-6/12'>
                ...
                <p className='mt-3 text-justify text-gray-700 text-base'>Hai, hari ini aku mau sharing sedikit hasil pembelajaran aku tentang penggunaan kata kunci var, let, dan const untuk pembuatan variabel di javascript.</p>
